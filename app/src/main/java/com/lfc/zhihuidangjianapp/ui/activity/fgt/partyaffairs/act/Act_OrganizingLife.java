...
import com.lfc.zhihuidangjianapp.ui.activity.fgt.partyaffairs.fgt.Fgt_OrganizingLife;
...
public class Act_OrganizingLife extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData() {
        mFragments.add(Fgt_OrganizingLife.getInstance("0"));
        mFragments.add(Fgt_OrganizingLife.getInstance("1"));
        mFragments.add(Fgt_OrganizingLife.getInstance("2"));
