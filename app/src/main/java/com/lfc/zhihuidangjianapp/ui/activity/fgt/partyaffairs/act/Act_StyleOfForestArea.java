...
public class Act_StyleOfForestArea extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData() {
        mFragments.add(Fgt_StyleOfForestArea.getInstance("0"));
        mFragments.add(Fgt_StyleOfForestArea.getInstance("1"));
        mFragments.add(Fgt_StyleOfForestArea.getInstance("2"));
        mFragments.add(Fgt_StyleOfForestArea.getInstance("3"));
