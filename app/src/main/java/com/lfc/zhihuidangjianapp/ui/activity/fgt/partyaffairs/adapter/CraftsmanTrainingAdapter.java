...
public class CraftsmanTrainingAdapter extends BaseQuickAdapter<CraftsmanTrainingBean.DataBean.DatasBean, BaseViewHolder> {
    Context mContext;

    public CraftsmanTrainingAdapter(Context context, @Nullable List<CraftsmanTrainingBean.DataBean.DatasBean> data) {
        super(R.layout.item_organizinglife, data);
        mContext = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, CraftsmanTrainingBean.DataBean.DatasBean item) {
