package com.lfc.zhihuidangjianapp.adapter.baseadapterL;
...
public abstract class ListBaseAdapter<T> extends RecyclerView.Adapter<SuperViewHolder> {
    ...
    public ListBaseAdapter(Context context, int resId) {
        mContext = context;
    ...
    public SuperViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(ResId, parent, false);
